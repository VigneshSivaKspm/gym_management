...
const TraineeDashboard = () => {
    ...
    async function fetchData() {
      ...
      try {
        ...
        setUserData({
          ...
          height:
            p.height !== undefined && p.height !== null ? p.height + " cm" : "",
          weight:
            p.weight !== undefined && p.weight !== null ? p.weight + " kg" : "",
          age: p.age || "",
          goal: p.goal || "",
          targetWeight:
            p.target_weight !== undefined && p.target_weight !== null
              ? p.target_weight + " kg"
              : "",
  ...
  const handleCheckIn = async () => {
    try {
      ...
      const errorMsg =
        err.response?.data?.detail || err.message || "Failed to check in";
  ...
  const handleCheckOut = async () => {
    try {
      ...
      toast.success(
        `✅ Checked out! Duration: ${res.data?.duration_minutes || 0} minutes`,
      );
      await fetchAttendanceData();
    } catch (err) {
  ...
  const stopWorkout = async () => {
    ...
    try {
      ...
      (await traineeApi.logManualWorkout)
        ? traineeApi.logManualWorkout(payload)
        : null;
    } catch (err) {
  ...
  const navTabs = [
    ...
    },
    {
      ...
      label: "Profile",
      icon: User,
      color: "text-slate-600 bg-gray-50",
    },
  ];
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50">
        ...
        >
          ...
          />
          <h2 className="text-lg sm:text-xl font-bold mb-2 text-slate-900">
            Loading Dashboard
          </h2>
          <p className="text-slate-600 text-center text-sm">
            Getting your fitness data ready...
          </p>
        </motion.div>
      </div>
    );
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 px-4">
        ...
        >
          ...
          <p className="text-slate-600 mb-6 text-center text-sm">
            {loadError ||
              "We couldn't load your dashboard data. Please check your login or try again later."}
          </p>
      ...
      <div className="flex pt-[88px] sm:pt-[100px] lg:pt-20">
        ...
        >
          <div className="p-6 h-full overflow-y-auto">
            {/* Navigation Section */}
            <div className="mb-8">
              <h2 className="text-sm font-bold text-slate-500 dark:text-slate-400 mb-4 tracking-wider uppercase">
                Navigation
              </h2>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100 hover:border-primary-300 transition-colors">
                    ...
                    <span className="font-bold text-lg text-indigo-400">
                      {typeof stats.caloriesBudget === "number" &&
                      typeof stats.calories === "number" &&
                      typeof stats.caloriesBurned === "number"
                        ? stats.caloriesBudget -
                          stats.calories +
                  ...
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100 hover:border-blue-300 transition-colors">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-lg text-blue-600">
                        {typeof stats.waterIntake === "number"
                          ? stats.waterIntake
                          : "--"}
                      </span>
                      <span className="text-slate-400">/</span>
                      <span className="text-slate-500 text-sm">
                        {typeof stats.waterGoal === "number"
                          ? stats.waterGoal
                          : "--"}
                      </span>
                    </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 sm:gap-6">
                        ...
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div>
                            <h1 className="text-2xl sm:text-3xl font-bold">
                              Welcome back,{" "}
                              {userData ? userData.name.split(" ")[0] : "Champ"}
                              !
                            </h1>
                      ...
                      >
                        <p className="text-xs font-bold text-white/90 mb-3 uppercase tracking-wide">
                          Quick Check-in
                        </p>
                            ...
                            <div>
                              ...
                              {attendanceData?.duration_minutes && (
                                <span className="text-xs text-white/70">
                                  {attendanceData.duration_minutes} min
                                </span>
                              )}
                            </div>
                          </div>
                  ...
                  {stats
                    ? [
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`w-12 h-12 rounded-xl ${stat.iconBg} flex items-center justify-center mb-4 shadow-sm group-hover:scale-110 transition-transform`}
                            >
                              <Icon className={`w-6 h-6 ${stat.iconColor}`} />
                            </div>
                            <div
                              className={`text-3xl font-extrabold ${stat.textColor} mb-1`}
                            >
                              {stat.value}
                            </div>
                    ...
                    : [...Array(4)].map((_, i) => (
                        <div
                          key={i}
                          className="h-40 bg-slate-900/50 rounded-2xl animate-pulse border border-slate-800"
                        />
                      ))}
                </motion.div>
                  ...
                  <div className="bg-slate-900 rounded-2xl p-5 sm:p-6 border border-slate-800 shadow-lg">
                    ...
                    {stats ? (
                      <div className="space-y-4">
                        ...
                        <motion.div
                          whileHover={{ x: 4 }}
                          className="p-4 bg-green-500/10 rounded-xl border border-green-500/30 hover:border-green-500/50 transition-colors"
                        >
                          ...
                          <div className="w-full h-2 bg-slate-800 rounded-full overflow-hidden">
                            <motion.div
                              initial={{ width: 0 }}
                              animate={{
                                width: `${Math.min((stats.calories / stats.caloriesBudget) * 100, 100)}%`,
                              }}
                              className="h-full bg-gradient-to-r from-green-500 to-green-400 rounded-full"
                            />
                          </div>
                          <p className="text-xs text-slate-400 mt-2">
                            of {stats.caloriesBudget} cal budget
                          </p>
                        </motion.div>
                        ...
                        <motion.div
                          whileHover={{ x: 4 }}
                          className="p-4 bg-orange-500/10 rounded-xl border border-orange-500/30 hover:border-orange-500/50 transition-colors"
                        >
                          <div className="flex items-center justify-between mb-2">
                            <div className="flex items-center gap-3">
                            ...
                            >
                              ...
                              <motion.circle
                                ...
                                animate={{
                                  strokeDashoffset:
                                    339.29 *
                                    (1 - stats.waterIntake / stats.waterGoal),
                                }}
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                      <div>
                        ...
                        <p className="text-emerald-100">
                          Track your gym visits and build consistency
                        </p>
                      </div>
                          ...
                          <div className="text-center">
                            ...
                            {attendanceData?.duration_minutes && (
                              <p className="mt-2 text-emerald-100 text-sm">
                                Duration: {attendanceData.duration_minutes}{" "}
                                minutes
                              </p>
                            )}
                          </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl p-5 text-white">
                      ...
                      <p className="text-3xl font-bold">
                        {attendanceStats?.this_month_visits || 0}
                      </p>
                    ...
                    <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl p-5 text-white">
                      ...
                      <p className="text-3xl font-bold">
                        {attendanceStats?.total_visits || 0}
                      </p>
                    ...
                    <div className="bg-gradient-to-br from-orange-500 to-amber-500 rounded-2xl p-5 text-white">
                      ...
                      <p className="text-3xl font-bold">
                        {attendanceStats?.avg_duration || 0}
                      </p>
                  ...
                  {attendanceHistory.length === 0 ? (
                    <div className="p-12 text-center">
                      ...
                      <p className="text-slate-400 dark:text-slate-500">
                        Start tracking your gym visits by checking in!
                      </p>
                    </div>
                  ) : (
                    <div className="divide-y divide-gray-100 dark:divide-gray-700">
              ...
              <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-700 dark:text-slate-300">
                          ...
                          {currentMembership.days_remaining} days remaining
                        </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  {plans.length === 0 ? (
                    <div className="col-span-full text-center py-12 bg-slate-900 rounded-2xl border border-slate-800">
                      ...
                      <p className="text-slate-400 dark:text-slate-500">
                        Contact admin to add membership plans
                      </p>
                    </div>
                  ) : (
                ...
                <div className="bg-gray-50 dark:bg-slate-800/50 rounded-xl p-4 text-center border border-slate-800">
                  <p className="text-slate-500 dark:text-slate-400 text-sm flex items-center justify-center gap-2">
                    ...
                    Secure payments powered by Razorpay. Your payment
                ...
                <div className="bg-gradient-to-br from-teal-500 via-cyan-500 to-blue-500 rounded-3xl p-6 lg:p-8 text-white shadow-2xl relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-teal-100">
                      Chat with your trainer or admin
                    </p>
                    {unreadCount > 0 && (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-slate-900 rounded-2xl shadow-lg overflow-hidden border border-slate-800">
                    ...
                    <div className="max-h-[500px] overflow-y-auto">
                      ...
                      {conversations.map((conv) => (
                        ...
                        >
                          ...
                          <div className="flex-1 text-left">
                            ...
                            <span className="text-[10px] text-teal-600 dark:text-teal-400 bg-teal-50 dark:bg-teal-900/30 px-2 py-0.5 rounded-full">
                              {conv.user_role}
                            </span>
                          </div>
                        </button>
                      ...
                      {contacts.filter(
                        (c) =>
                          !conversations.find((conv) => conv.user_id === c.id),
                      ).length > 0 && (
                          ...
                          {contacts
                            ...
                            .map((contact) => (
                              ...
                              >
                                ...
                                <div className="flex-1 text-left">
                                  <p className="font-medium text-slate-700 dark:text-gray-200 text-sm">
                                    {contact.name}
                                  </p>
                            ...
                            conversationMessages.map((msg) => (
                              ...
                              >
                                ...
                                >
                                  ...
                                  <p
                                    className={`text-[10px] mt-1 ${msg.is_mine ? "text-teal-100" : "text-slate-400 dark:text-slate-500"}`}
                                  >
                                    {msg.created_at
                                      ? new Date(
                                          msg.created_at,
