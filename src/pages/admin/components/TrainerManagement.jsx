  ...
  const handleCreateTrainer = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        experience_years: trainerForm.experience_years
          ? parseInt(trainerForm.experience_years)
          : 0,
        certifications: trainerForm.certifications || null,
        salary_model: trainerForm.salary_model || "fixed",
        base_salary: trainerForm.base_salary
          ? parseFloat(trainerForm.base_salary)
          : 0,
        commission_per_session: trainerForm.commission_per_session
          ? parseFloat(trainerForm.commission_per_session)
          : 0,
        bio: trainerForm.bio || null,
      };
      const res = await adminApi.createTrainer(payload);
      toast.success(
        `Trainer created! Temp password: ${res.data.login_password}`,
      );
      setTrainerForm({
        name: "",
        email: "",
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-4">
        <div>
          ...
          <p className="text-slate-300 text-base mt-2 font-medium">
            Add trainers, view details, manage payouts, attendance, salary, and
            assignments.
          </p>
        </div>
        <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. vignesh@k7-fitness.com"
                    required
                  />
                </div>
                <div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setTrainerForm({
                          ...trainerForm,
                          commission_per_session: e.target.value,
                        })
                      }
                      placeholder="e.g. 500"
                    />
        ...
        {filteredTrainers.map((t, index) => (
          ...
          >
            ...
            <div className="absolute top-4 right-4 z-10">
              <span
                className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold shadow-sm backdrop-blur-sm ${
                  t.status === "active"
            ...
            <div className="relative p-6 flex flex-col h-full">
              ...
              <div className="grid grid-cols-2 gap-3 mb-5">
                ...
                <div className="group/stat bg-gradient-to-br from-purple-50 to-purple-100/70 rounded-xl p-4 border border-purple-200/50 hover:shadow-md transition-all duration-300">
                  ...
                  <p className="text-2xl font-bold text-purple-700 mb-0.5">
                    {t.assigned_trainees || 0}
                  </p>
                    ...
                    {t.commission_per_session && (
                      <div className="flex-1 min-w-[120px] bg-white px-3 py-2.5 rounded-lg border border-cyan-200/50 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-lg font-bold text-cyan-700">
                          ₹{t.commission_per_session.toLocaleString()}
                        </p>
                      </div>
                    )}
                  </div>
        ...
        {filteredTrainers.length === 0 && !loading && (
          <div className="col-span-full bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-xl p-12 text-center border border-blue-100">
            ...
            <p className="text-slate-500 text-sm mb-6">
              Start managing your gym by adding trainers
            </p>
            <button
              onClick={() => setShowAddModal(true)}
      ...
      <div className="relative w-full max-w-2xl bg-white h-full shadow-2xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="bg-sky-50 rounded-lg p-4">
            ...
            <div className="font-semibold text-orange-700 mt-2">
              Base Salary
            </div>
            ...
            <div className="space-y-2">
              {trainees.length === 0 ? (
                ...
                trainees.map((t) => (
                  <div
                    key={t.id}
                    className="bg-slate-50 rounded-lg p-2 flex items-center justify-between"
                  >
                    <div>
                    ...
                    attendance.map((a, idx) => (
                      <tr key={idx}>
                        ...
                        <td className="px-2 py-1">
                          {a.check_in?.slice(11, 16) || "—"}
                        </td>
                        <td className="px-2 py-1">
                          {a.check_out?.slice(11, 16) || "—"}
                        </td>
          ...
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-sm text-slate-600 mb-4">
              ...
              <span className="font-semibold">
                {passwordResetTarget?.user?.name}
              </span>{" "}
              ({passwordResetTarget?.user?.email})
            </p>
