              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-700 border border-slate-600 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-transparent transition"
                    placeholder="admin@k7-fitness.com"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-slate-300 mb-2">
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  icon: AlertCircle,
                  desc: "Alerts when equipment needs maintenance",
                },
                {
                  key: "schedule_notifications",
                  label: "Schedule & Class Notifications",
                  icon: Clock,
                  desc: "Notifications for schedule changes",
                },
              ].map((item) => (
                <div
                  key={item.key}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <label className="text-gray-200 font-semibold cursor-pointer block">
                        {item.label}
                      </label>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-5 bg-slate-700/50 rounded-xl hover:bg-slate-700 transition border border-slate-600">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <label className="text-gray-200 font-bold cursor-pointer block text-lg">
