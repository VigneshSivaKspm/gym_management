...
const Login = () => {
  ...
  useEffect(() => {
    const savedEmail = localStorage.getItem("k7_fitness_remember_email");
    if (savedEmail) {
      setEmail(savedEmail);
      setRememberMe(true);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (rememberMe && email) {
      localStorage.setItem("k7_fitness_remember_email", email);
    } else {
      localStorage.removeItem("k7_fitness_remember_email");
    }
  ...
  const handleForgotPassword = async (e) => {
    ...
    alert(
      `Password reset link has been sent to ${forgotEmail}. Check your email!`,
    );
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-8 px-4">
      ...
      <div className="w-full max-w-6xl mx-auto relative z-10 flex flex-col lg:flex-row gap-6 sm:gap-8 items-center px-4 sm:px-6">
        ...
        <div className="hidden lg:flex lg:flex-1 flex-col gap-8 animate-slide-up">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-slate-300 leading-relaxed max-w-xl">
              Join the ultimate fitness platform powered by AI. Track, train,
              and transform with personalized guidance.
            </p>
          </div>
          ...
          <div className="relative h-32 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden">
            {slides.map((slide, index) => (
              ...
              >
                <div
                  className={`flex items-center justify-center w-16 h-16 bg-gradient-to-br ${slide.color} rounded-2xl shadow-lg`}
                >
                  {slide.icon}
                </div>
        ...
        <div
          className="w-full lg:flex-1 max-w-md animate-slide-up"
