...
const Login = () => {
  ...
  useEffect(() => {
    const savedEmail = localStorage.getItem('gym_pro_remember_email');
    if (savedEmail) {
      setEmail(savedEmail);
      setRememberMe(true);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (rememberMe && email) {
      localStorage.setItem('gym_pro_remember_email', email);
    } else {
      localStorage.removeItem('gym_pro_remember_email');
    }
