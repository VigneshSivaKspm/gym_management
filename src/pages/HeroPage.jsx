      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl overflow-hidden shadow-lg ring-2 ring-yellow-500/60 bg-white flex items-center justify-center">
              <img 
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.innerHTML = '<span class="text-yellow-600 font-black text-lg">GP</span>';
                }}
              />
            </div>
            <div>
              <h1 className="text-white font-black text-lg md:text-2xl tracking-tight">Gym_Pro</h1>
              <p className="text-yellow-400 text-xs md:text-sm font-semibold">Premium Gym • [Location]</p>
            </div>
          </motion.div>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Your premier fitness destination with professional trainers, state-of-the-art equipment, and personalized training programs to help you achieve your goals.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto lg:mx-0">
              ...
              <motion.a
                href="https://instagram.com/gym_pro"
                target="_blank"
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-white font-bold text-sm">@gym_pro</p>
                </div>
              </motion.a>
            </div>
            ...
            <div className="w-full max-w-md relative">
              ...
              <div className="relative bg-gray-900/90 backdrop-blur-2xl p-8 rounded-3xl border border-yellow-500/40 shadow-2xl shadow-yellow-500/10 flex flex-col items-center space-y-6">
                ...
                <div className="w-full text-center space-y-5">
                  <div>
                    <h2 className="text-2xl font-black text-white mb-1">Gym_Pro</h2>
                    <p className="text-yellow-400 text-sm font-semibold tracking-wider">PREMIUM GYM</p>
                  </div>
                  ...
                  <div className="bg-gray-800/60 backdrop-blur-sm p-5 rounded-xl border border-yellow-500/20 space-y-2">
                    ...
                    <div className="space-y-1">
                      <p className="text-gray-200 text-sm font-medium">[Building Name]</p>
                      <p className="text-gray-200 text-sm font-medium">[Street Address]</p>
                      <p className="text-gray-200 text-sm font-medium">[City, State] [Zip Code]</p>
                    </div>
                  </div>
        ...
        >
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-white mb-4">
              Why Choose <span className="bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">Gym_Pro?</span>
            </h2>
        ...
        >
          <div className="bg-gray-800/50 backdrop-blur-xl p-12 rounded-3xl border border-yellow-500/20 max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">Start your fitness transformation with us today</p>
            </div>
              ...
              >
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <a href="tel:[PhoneNumber]" className="text-white text-xl font-bold hover:text-yellow-400 transition-colors">
                      [Phone Number]
                    </a>
                  </div>
                </div>
          ...
          <div className="relative bg-gradient-to-r from-yellow-500/15 to-orange-500/15 backdrop-blur-xl p-16 rounded-3xl border border-yellow-500/30 max-w-4xl mx-auto overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-gray-300 text-xl max-w-2xl mx-auto">
                Join Gym_Pro today and achieve your fitness goals with professional guidance and state-of-the-art equipment
              </p>
              <button
                onClick={() => handleNavigation('/login')}
        ...
        <footer className="py-8 border-t border-yellow-500/20 text-center space-y-4">
          <div className="flex items-center justify-center gap-6">
            <a href="tel:[PhoneNumber]" className="flex items-center gap-2 text-gray-400 hover:text-yellow-400 transition-colors">
          ...
          <p className="text-gray-400 font-medium">&copy; 2026 Gym_Pro. All rights reserved.</p>
          <p className="text-yellow-400/70 text-sm">📍 [Location Address]</p>
        </footer>
      </div>
    </div>
  );
