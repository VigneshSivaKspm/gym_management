      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.innerHTML =
                    '<span class="text-yellow-600 font-black text-lg">GP</span>';
                }}
              />
            </div>
            <div>
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Your premier fitness destination with professional trainers,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto lg:mx-0">
              ...
              <motion.a
                href="https://instagram.com/k7fitness"
                target="_blank"
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-white font-bold text-sm">@k7fitness</p>
                </div>
              </motion.a>
            </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg font-medium">
              Professional training with world-class facilities and certified
              experts
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Specialized programs for muscle building and conditioning",
              },
              {
                icon: <Salad className="w-7 h-7" />,
                title: "Nutrition Plans",
                description: "Expert diet guidance to maximize your results",
              },
              {
                icon: <Clock className="w-7 h-7" />,
                title: "Flexible Timing",
                description: "Convenient hours to fit your busy schedule",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl p-12 rounded-3xl border border-yellow-500/20 max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-lg">
                Start your fitness transformation with us today
              </p>
            </div>
          ...
          <div className="relative bg-gradient-to-r from-yellow-500/15 to-orange-500/15 backdrop-blur-xl p-16 rounded-3xl border border-yellow-500/30 max-w-4xl mx-auto overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-gray-300 text-xl max-w-2xl mx-auto">
                Join K7 Fitness today and achieve your fitness goals with
                professional guidance and state-of-the-art equipment
              </p>
              <button
                onClick={() => handleNavigation("/login")}
        ...
        <footer className="py-8 border-t border-yellow-500/20 text-center space-y-4">
          ...
          <p className="text-gray-400 font-medium">
            &copy; 2026 K7 Fitness. All rights reserved.
          </p>
