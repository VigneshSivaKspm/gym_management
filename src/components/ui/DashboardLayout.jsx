  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white shadow-md z-40 flex items-center justify-between px-4 py-3">
        <h1 className="text-xl font-bold text-slate-900">K7 Fitness</h1>
        <button
      ...
      <div className="md:ml-64">
        {/* Header */}
        {header && (
          <div className="sticky top-0 bg-white border-b border-slate-200 shadow-sm z-20 hidden md:block">
            {header}
          </div>
        )}
        ...
        {/* Content */}
        <main className={`section-container min-h-screen ${className}`}>
          {children}
        </main>
      </div>
    </div>
  ...
  return (
    <div className={`flex flex-col h-full ${className}`}>
      ...
      <div className="p-6 border-b border-slate-700">
        <h2 className="text-xl font-bold">K7 Fitness</h2>
